...
const RequestPayment = () => {
	...
	return (
		<div className="md:p-8 w-full mt-4 font-outfit">
			<div
				className="flex gap-1 mb-8 cursor-pointer text-gray-400"
				onClick={() => navigate(-1)}
			>
				<ArrowLeft />
				Back
				...
				<div className="bg-white w-full rounded-lg p-5 shadow-md">
					<div className="flex flex-col justify-center gap-8">
						<div className="flex flex-col">
							...
							<select className="p-3 border border-gray-400 w-full rounded-lg">
								...
								{properties.map((property, idx) => (
									<option value={property.id} key={idx}>
										{property.title}
									</option>
								))}
							</select>
						...
						<div className="flex flex-col">
							...
							<input
								type="number"
								className="p-3 rounded-lg w-full border border-gray-400"
							/>
							<span className="text-xs text-gray-400 leading-3 mt-2">
								This amount will be moved into an escrow upon client payment
							</span>
						</div>
						<div className="flex gap-3 bg-[#fff9e3] p-2 border border-amber-400 rounded-lg">
							...
							<div className="flex flex-col">
								...
								<p className="text-amber-800">
									This is a local property. Deadline is{' '}
									<strong>
